...
const AdminDashboard = ({
  ...
  const handleAddClick = (type) => {
    ...
    if (["mansion", "penthouse", "luxury collectible"].includes(type)) {
      navigate("/mansionform");
    }
  };

  // Fetch inquiries from /api/admin/inquiries
  useEffect(() => {
  ...
  // Fetch properties for mansions and penthouses
  useEffect(() => {
  ...
  // Filtering logic for properties and luxury collectibles
          ...
          <div className="overflow-x-auto font-inter">
            <div className="flex justify-between items-center mb-2">
              ...
              <div className="flex items-center gap-2">
                <input
                  type="text"
                  placeholder="Search by Email, Name, Property Ref, or Title"
...
uszcz                  <th className="py-2 px-2 border">Reference no</th>
                  <th className="py-2 px-2 border">Property Ref</th>
                  <th className="py-2 px-2 border">Property Title</th>
              ...
              <tbody>
                {loading ? (
                  <tr>
                    <td colSpan="10" className="py-2 px-2 border text-center">
                      Loading...
                    </td>
                  </tr>
                ) : error ? (
